        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-information.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        $i=1;
                                        $koneksi = koneksiUts();
                                        $data = mysqli_query($koneksi, "SELECT * FROM information ORDER BY id DESC");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['link'];?></td>
                                                <td>
                                                    <a href="update-information.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Edit</a>
                                                    <a href="hapus-information.php?&id=<?= $row["id"];?>"
