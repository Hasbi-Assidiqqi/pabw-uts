        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-contact.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['isi'];?></td>
                                                <td>
                                                    <a href="update-contact.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Edit</a>
                                                    <a href="hapus-contact.php?&id=<?= $row["id"];?>"
