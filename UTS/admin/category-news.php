        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-category-news.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah
                        Data</a>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        $i=1;
                                        $koneksi = koneksiUts();
                                        $data = mysqli_query($koneksi, "SELECT * FROM news_category ORDER BY id ASC");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td><?= $row['judul'];?></td>
                                                <td>
                                                    <a href="update-category-news.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Edit</a>
                                                    <a href="hapus-category-news.php?&id=<?= $row["id"];?>"
