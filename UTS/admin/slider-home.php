        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-slider-home.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Slider Home</h1>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $i=1;
                                            $koneksi = koneksiUts();
                                            $data = mysqli_query($koneksi, "SELECT * FROM slider_home ORDER BY id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['deskripsi'];?></td>
                                                <td>
                                                    <a href="update-slider-home.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Edit</a>
                                                    <a href="hapus-slider-home.php?&id=<?= $row["id"];?>"
