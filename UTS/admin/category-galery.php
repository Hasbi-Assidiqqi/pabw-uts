        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-category-galery.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah
                        Data</a>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        $i=1;
                                        $koneksi = koneksiUts();
                                        $data = mysqli_query($koneksi, "SELECT * FROM galery_category ORDER BY id ASC");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td><?= $row['judul'];?></td>
                                                <td>
                                                    <a href="update-category-galery.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Edit</a>
                                                    <a href="hapus-category-galery.php?&id=<?= $row["id"];?>"
