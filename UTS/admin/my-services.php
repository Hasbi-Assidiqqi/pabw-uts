        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-my-services.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">My Services</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        $i=1;
                                        $koneksi = koneksiUts();
                                        $data = mysqli_query($koneksi, "SELECT * FROM my_services ORDER BY id ASC");
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['deskripsi'];?></td>
                                                <td>
                                                    <a href="update-my-services.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Edit</a>
                                                    <a href="hapus-my-services.php?&id=<?= $row["id"];?>"
