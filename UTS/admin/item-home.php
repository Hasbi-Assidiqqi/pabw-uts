        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <a href="create-item-home.php" class="btn btn-primary" style="margin-bottom:5px;">Tambah Data</a>
                    <div class="row mb-2">
                        <div class="col-sm-6">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $i=1;
                                            $koneksi = koneksiUts();
                                            $data = mysqli_query($koneksi, "SELECT * FROM item_home ORDER BY id DESC");
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['deskripsi'];?></td>
                                                <td>
                                                    <a href="update-item-home.php?&id=<?= $row["id"]; ?>"
                                                        class="btn btn-info">Edit</a>
                                                    <a href="hapus-item-home.php?&id=<?= $row["id"];?>"
