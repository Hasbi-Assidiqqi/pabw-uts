        ...
        <div class="col-md-8">
            ...
            <section id="news-main">
                <div class="row">
                    ...
                    $i = 1;
                    $koneksi = koneksiUts();
                    $news = mysqli_query($koneksi, "SELECT * FROM galery WHERE kategori = '$id' ORDER BY id DESC ");
                ...
                <div class="card-body">
                    <div class="paginition left">
                        <ul>
                            ...
                            $i = 1;
                            $koneksi = koneksiUts();
                            $news = mysqli_query($koneksi, "SELECT * FROM galery_category ORDER BY id ASC ");
                            while ($row = mysqli_fetch_array($news)) {
                            ?>
    ...
    <div class="card my-4">
        ...
        <div class="card-body-information">
            <div class=" row">
                ...
                $i = 1;
                $koneksi = koneksiUts();
                $information = mysqli_query($koneksi, "SELECT * FROM information ORDER BY id ASC ");
